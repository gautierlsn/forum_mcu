...
<div class="container mt-5">
    ...
    foreach ($comments as $Onecomment) {
        ...
        <?php if (isset($_SESSION['ROLE']) && $_SESSION['ROLE'] == 1) { ?>
            <a href="../Script_PHP/do_delete.php?action=deleteMessage&idMessage=<?=$Onecomment["id_message"]?>&idTopic=<?=$idTopic?>"><button class="btn btn-danger btn_show_topic"><i class="fas fa-trash-alt"></i></button></a>
