...
INSERT INTO `discussion` (`id_discussion`, `titre`, `date_creation`, `id_utilisateur`) VALUES
(1, 'Est ce que sa marche ?', '2022-01-27', 1),
(2, 'Sa marche toujours ?', '2022-01-27', 1);
...
ALTER TABLE `discussion`
  ...
  ADD KEY `Discussion_Utilisateur_FK` (`id_utilisateur`);
